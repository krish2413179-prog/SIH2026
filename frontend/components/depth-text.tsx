...
const DepthText = ({
  ...
  const rootStyle: CSSProperties = {
    ...style,
    ['--depth-text-perspective' as string]: `${safePerspective}px`,
    ['--depth-text-font-size'   as string]: fontSize,
    ['--depth-text-font-weight' as string]: fontWeight,
    ['--depth-text-face-color'  as string]: faceColor,
    ['--depth-text-depth-color' as string]: depthColor,
    ['--depth-text-shadow'      as string]: shadow
